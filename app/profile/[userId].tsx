...
import { ChevronLeft, Smile, Sparkles } from 'lucide-react-native';
                ...
                <View style={styles.profileInfo}>
                    <View style={styles.avatarContainer}>
                        {profile.avatarUrl ? (
                            ...
                            <View style={[styles.avatar, styles.placeholderAvatar, { backgroundColor: theme.border }]}>
                                <Smile color={theme.textSecondary} size={40} />
                            </View>
                        )}
                    ...
                    <View style={[styles.moodBadge, { backgroundColor: moodColor + '20' }]}>
                        ...
                        <Text style={[styles.moodBadgeText, { color: moodColor }]}>
                            {profile.dominantMood.charAt(0).toUpperCase() + profile.dominantMood.slice(1)} Aura
                        </Text>
                    </View>
                </View>
